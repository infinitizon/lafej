...
<head>
        ...
        <link href="<?php echo asset_url(); ?>bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo asset_url(); ?>font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet">
        <link href="<?php echo asset_url(); ?>plugins/icomoon/style.css" rel="stylesheet">
        <link href="<?php echo asset_url(); ?>plugins/uniform/css/default.css" rel="stylesheet"/>
        <link href="<?php echo asset_url(); ?>plugins/switchery/switchery.min.css" rel="stylesheet"/>
      
        <!-- Theme Styles -->
        <link href="<?php echo asset_url(); ?>css/space.min.css" rel="stylesheet">
...
?>
        ...
        <script src="<?php echo asset_url(); ?>plugins/jquery-slimscroll/jquery.slimscroll.min.js"></script>
        <script src="<?php echo asset_url(); ?>plugins/uniform/js/jquery.uniform.standalone.js"></script>
        <script src="<?php echo asset_url(); ?>plugins/switchery/switchery.min.js"></script>
        <script src="<?php echo asset_url(); ?>js/space.min.js"></script>
